...
################################################################################
## Form generated from reading UI file 'orion_v6.ui'
##
...
class Ui_mainWindow(object):
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.configButton.setText(QCoreApplication.translate("mainWindow", u"CSVs", None))
        self.profileButton.setText(QCoreApplication.translate("mainWindow", u"Profiles", None))
    # retranslateUi
